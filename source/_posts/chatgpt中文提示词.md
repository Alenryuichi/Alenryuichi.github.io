---
title: chatgpt中文使用（提示词prompt）指南
toc: true
date: 2023-03-23 02:46:26
updated:
sticky: 3
tags:
  - chatgpt
...
description:
top_img:
comments: ChatGPT中文Prompt是一种基于GPT-3的自然语言处理模型，它可以帮助你生成各种类型的文本，包括学术论文、创意写作、内容创作、商业写作、学术编辑、翻译、数据分析、技术文档、教育培训、网站内容、研究咨询、演讲稿、个人陈述、简历和求职信、广告文案、SEO优化、社交媒体、新闻稿、多语言翻译、电子商务、旅游文案、医疗文案、儿童读物、小说等。它可以为你提供高质量、独特、易读的文本，帮助你吸引读者和提升品牌知名度。
cover:
toc_number:
toc_style_simple:
copyright:
